...
struct SeedLib{
    let seeds = [
        ...
        SeedSetting(NO:4,Name:"調羹喵",Image:"cat04",Spec:false,Info:"就是湯匙。"),
//        SeedSetting(NO:4,Name:"牙膏喵",Image:"cat04",Spec:false,Info:"以為是瞇瞇眼的貓，事實上只是因為牙膏太涼，永遠都睜不開眼睛。\n\n雖然常常痛得流淚，但似乎被當成牙膏裡的有益成分所以沒人關心他的心情。"),
